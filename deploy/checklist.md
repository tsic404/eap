...
- [ ] `.env` 已配置全部必需变量：`DATABASE_URL`、`REDIS_URL`、`DIFY_API_BASE_URL`、`DIFY_CONSOLE_EMAIL`、`DIFY_CONSOLE_PASSWORD`、`OIDC_ISSUER`、`OIDC_CLIENT_ID`、`OIDC_CLIENT_SECRET`、`JWT_PRIVATE_KEY`、`JWT_PUBLIC_KEY`、`DIFY_SECRET_KEY`、`WEAVIATE_API_KEY`
